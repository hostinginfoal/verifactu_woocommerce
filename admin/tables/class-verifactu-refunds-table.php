...
class Verifactu_Refunds_Table extends WP_List_Table {

    public function __construct() {
        parent::__construct( array(
            'singular' => __( 'Abono', 'verifactu-infoal' ),
            'plural'   => __( 'Abonos', 'verifactu-infoal' ),
            'ajax'     => false,
        ) );
    }
    ...
    public function get_columns() {
        return array(
            ...
            'id_order'         => __( 'Abono ID', 'verifactu-infoal' ),
    ...
    public function prepare_items() {
        ...
        $table_name = $wpdb->prefix . 'verifactu_order_refund';
        $per_page   = 20;
        ...
        $orderby = isset( $_GET['orderby'] ) ? sanitize_sql_orderby( wp_unslash( $_GET['orderby'] ) ) : 'fecha_envio';
